...
## 1. httpServer.py
    ```python
    python httpServer.py --host=localhost --port=10000
    ```
## 2. tcpClient.py
    ```python
...
## 3. conda listd
    ...
    debugpy                   1.8.7           py312h6f74592_0    conda-forge
    ...
    gh                        2.59.0               h94b2740_0    conda-forge
    ...
    ld_impl_linux-aarch64     2.43                 h80caac9_1    conda-forge
    ...
    markupsafe                3.0.2           py312h74ce7d3_0    conda-forge
    ...
    zeromq                    4.3.5                h5efb499_6    conda-forge
